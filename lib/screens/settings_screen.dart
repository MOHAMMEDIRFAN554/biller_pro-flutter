                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text('Enable QR in POS', style: TextStyle(fontSize: 14)),
                      ),
                      Switch(
                        value: _settings['enableQrPayments'] == true,
                        onChanged: null, // UI only for now as per web parity
                      ),
                    ],
                  ),
                ),
